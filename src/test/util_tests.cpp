...
BOOST_AUTO_TEST_CASE(util_DateTimeStrFormat)
{
    ...
    BOOST_CHECK_EQUAL(DateTimeStrFormat("%Y-%m-%d %H:%M:%S", 1317425EZPAY), "2011-09-30 23:36:17");
    BOOST_CHECK_EQUAL(DateTimeStrFormat("%Y-%m-%d %H:%M", 1317425EZPAY), "2011-09-30 23:36");
    BOOST_CHECK_EQUAL(DateTimeStrFormat("%a, %d %b %Y %H:%M:%S +0000", 1317425EZPAY), "Fri, 30 Sep 2011 23:36:17 +0000");
}
