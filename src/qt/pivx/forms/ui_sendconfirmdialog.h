...
"}"));
        ...
        labelDividerID->setStyleSheet(QStringLiteral("background-color:#f2f2f2;"));
...
"}"));
        ...
        labelDividerOutputs->setStyleSheet(QStringLiteral("background-color:#f2f2f2;"));
        ...
        labelDividerPrevtx->setStyleSheet(QStringLiteral("background-color:#f2f2f2;"));
        ...
        labelDividerFeeSize->setStyleSheet(QStringLiteral("background-color:#f2f2f2;"));
        ...
        labelDividerChange->setStyleSheet(QStringLiteral("background-color:#f2f2f2;"));
        ...
        labelDividerConfs->setStyleSheet(QStringLiteral("background-color:#f2f2f2;"));
