    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < nRequiredConfs)
                ...
                strReason = "Your wallet is locked. Impossible to spend zEZPAY.";
            else if (!mint.isSeedCorrect)
                strReason = "The zEZPAY seed used to mint this zEZPAY is not the same as currently hold in the wallet";
            else
